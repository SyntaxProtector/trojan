...
cl = LINETCR.LINE()
cl.login(token='ElE51JEz6d0e6ESUDps0.SVU0J3aZCEDk5M6Zjd9Uqa.mTdkl3ntke/bH9bHNn2Sgtf7hrCG9wuDj4ESVl2ZecA=')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='Elpla0g89RAqTnKeKeVb.nKIySmmdCjjs3oxvJMs9gW.s5igo9DYMfnLJuaKnSPUzd7GzoS2gPY71nq+k0NkEhc=')
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token='ElIH1QZ2XLqHrLgaDfZf.VZEXmj3FxmVv36rfUwq+pW.yF/VoGQJrVK3nHwVO83y1VckivH/ZirIlhcPsRWdO9k=')
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token='El8iOuDf1CFcjEOQEgG5.XmFYi89C+8kLWNqDQdbHHq.2K1Mie32/54MlGJtTEKBDHPHrjISGdzNXDJCSdIHedw=')
kc.loginResult()

ks = LINETCR.LINE()
ks.login(token='El7AcEhx22LKimMwFw82.VscES4PwQRrJ7q8bUYmkaG.j25KWFnzAD4L/EwjeDZBJAU/nzdONx7/u/PpgeWMPws=')
ks.loginResult()

ka = LINETCR.LINE()
ka.login(token='ElX5ylJ2MmMoHznIAVP8.Y8rgIjYAu0OLABpsSi6+Aa.b4rFCXAnw7oHl/4Cnn6tYMUsXV/77fxbkfwzKtEFwE4=')
ka.loginResult()

kb = LINETCR.LINE()
kb.login(token='ElRvZlxgnK5GnsV27L85.V3Y2DOsQn2ZtHDNGx0AtLq.Uf5oOwpNbDcHxOcb/Wr2/4LzhGai3mdo8EdOE/aZTY8=')
kb.loginResult()

ko = LINETCR.LINE()
ko.login(token='EliSGUks5g9y7tzUJ40c.5L0jKAQWGsx7aPXjO5V6Za.ur+w15JTT715tfY41+MXgqpyFiMW/Y/hDI6UCHqhYUE=')
ko.loginResult()

ke = LINETCR.LINE()
ke.login(token='ElPEdGM2LCEOLIFwOnOf.ys+OeDdZxIXwxrSP5U5+tW.EUkG5+bY59WX0M7C0a07tKUtg+SMx8vjRkQOQv45yQA=')
ke.loginResult()

ku = LINETCR.LINE()
ku.login(token='ElR2yIUqTOVRC8OFwWUa.9yY6h3S3kCGbY3K0QeVSsG.gueQX3j9ESU9rE9sge3KvsjBDi4U6Rtv5W+qwrT2aV8=')
ku.loginResult()
...
admin=["ua5ac40e64c9203e094feff8b5d22832f"]
wait = {
    'contact':False,
    'autoJoin':True,
